...
const checks = [
  ...
  ['home mobile scroll axes are separated', app.includes('dragDirectionLock') && app.includes('Math.abs(verticalOffset) > Math.abs(dragOffset)') && css.includes('touch-action: pan-y')],
  ...
  ['reaction bar uses figma full width padding', css.includes('.reaction-bar') && css.includes('gap: 4px') && css.includes('width: calc(100% + 56px)') && css.includes('margin: 4px -28px 0') && css.includes('padding: 8px 28px')],
